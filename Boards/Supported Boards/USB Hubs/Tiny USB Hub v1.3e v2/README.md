# Tiny USB Hub v1.3E v2
![Tiny USB Hub v1.3E v2 01](Assets/Tiny%20USB%20Hub%20v1.3E%20v2%2001.png)
---
...
Please note that this design is a small update of the v1.3 design which allows for two larger dongles like the Brook FGC 1/2 to be connected beside each other.
...
3 - Click on `Add Gerber file` and choose the file named `Gerber - Tiny USB Hub v1.3E v2.zip`<br/>
...
- For the `Add BOM File` you will need to choose the `BOM - Tiny USB Hub v1.3E v2.csv` file that is located in the Hardware files folder
- For the `Add CPL File` you will need to choose the `CPL - Tiny USB Hub v1.3E v2.csv` file that is located in the Hardware files folder<br/>
...
v1.3 v2
- Moved the two USB A connectors further apart to allow for connection of wider dongles
