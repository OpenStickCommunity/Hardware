...
- 2 x M3 10mm countersunk hex bolts

Alt: More Snug Neutrik version
🔴IMPORTANT❗🔴
If you chose the More Snug Neutrik version you should replace the **2 x M3 10mm countersunk hex** bolts for:
...
- To mount a Neutrik passthrough you will need the 2x M3 10mm countersunk hex bolts. The Neutrik passthrough will be a tight fit and may need to be clamped into place.
